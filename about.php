        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:5rem;align-items:center">
            <div>
                ...
                <p style="font-size:1rem;color:var(--text-mid);line-height:1.8;margin-bottom:1.25rem">
                    WildNest began as a single hand-built treehouse on a family plot of highland forest in Benguet. The founder, Mang Ricardo — a former forest ranger and hobbyist carpenter — wanted one thing: a place where visitors could sleep inside the forest, not outside it.
                </p>
                <p style="font-size:1rem;color:var(--text-mid);line-height:1.8;margin-bottom:1.25rem">
                ...
                <p style="font-size:1rem;color:var(--text-mid);line-height:1.8;margin-bottom:2rem">
                    Today WildNest employs over 40 people — all from the Benguet community — and is recognized by the Department of Tourism as a model for sustainable highland eco-tourism.
                </p>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
                ...
                for ($i=0;$i<4;$i++): ?>
                <div style="aspect-ratio:1;background:<?=$colors[$i]?>;border-radius:var(--radius-lg);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:.75rem;color:white">
...
<section class="section">
    <div class="container">
        <div class="section-header center">
            ...
            <h2 class="section-title">The WildNest Family</h2>
            <p class="section-desc">Every person at WildNest calls the Benguet highlands home. Our guides grew up on these trails. Our chefs forage these forests. Our staff knows every guest by name.</p>
        </div>
        <div class="grid-4">
            <?php
            $team = [
    ...
    <div class="container">
        ...
        <div class="grid-3">
            ...
            $values = [
                ...
                ['fa-users','Community Economy','Every peso earned at WildNest stays local. We source food, materials, and labor from within 20km of the resort.'],
...
<section style="background:var(--stone);padding:5rem 0;text-align:center">
    <div class="container">
        ...
        <p style="font-size:1rem;color:var(--text-mid);max-width:480px;margin:0 auto 2rem;line-height:1.7">Stories can only go so far. Come spend a night in the canopy — or the river bank — and see what WildNest is really about.</p>

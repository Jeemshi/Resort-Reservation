...
<head>
    ...
    <title>Sign In — WildNest Resort</title>
    ...
    <div class="auth-left">
        <div style="position:relative;z-index:1;max-width:420px;text-align:center">
            ...
            <h1 style="font-family:var(--font-display);font-size:2.5rem;font-weight:900;color:white;margin-bottom:.75rem;line-height:1.1">
                Welcome Back,<br><span style="color:var(--ochre-light)">Wild One.</span>
            </h1>
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    <label class="form-label" style="display:flex;justify-content:space-between">
                        Password
                        <a href="#" style="color:var(--canopy);font-size:.8rem;font-weight:500">Forgot password?</a>
                    </label>
                ...
                <button type="submit" class="btn btn-primary" style="width:100%;justify-content:center;padding:1rem">
                    <i class="fas fa-sign-in-alt"></i> Sign In to WildNest
                </button>
            </form>

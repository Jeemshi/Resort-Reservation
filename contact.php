    ...
    <div class="container">
        <div style="display:grid;grid-template-columns:1fr 2fr;gap:4rem;align-items:start">
            ...
            <div>
                ...
                <p style="font-size:.95rem;color:var(--text-mid);line-height:1.7;margin-bottom:2rem">WildNest is tucked into the highland forest above Baguio City. Once you see the carved wooden sign and smell the pine, you'll know you're close.</p>
                ...
                $contacts = [
                    ...
                    ['fa-envelope','Email','hello@wildnest.com<br>bookings@wildnest.com'],
